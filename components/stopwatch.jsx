...
export default function StopWatch() {
  ...
  const lapsHandler = (time) => {
    ...
    setLaps((prevLaps) => {
      return [{ id: finalId.toString(), time: time }, ...prevLaps];
    });
  };
        ...
        <View style={styles.container}>
          <View style={styles.timer}>
            <Text style={[styles.timerText, styles.colorYellow]}>
              ...
              <Timer.Seconds />
              {/* Milliseconds */}
              <Text style={[styles.colorGray, styles.timerTextMilli]}>
                .
                <Timer.Milliseconds
                  formatValue={(value) =>
                    `${
          ...
          <View style={styles.buttons}>
            <TouchableOpacity
              ...
              onPress={() => {
                leftButtonHandler(getTimerState(), start, stop);
              }}
            >
            ...
            <TouchableOpacity
              style={styles.button}
              onPress={() => {
                rightButtonHandler(getTimerState(), getTime(), reset);
              }}
            >
